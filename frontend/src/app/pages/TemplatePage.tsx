...
function TemplateShell({
  ...
  return (
    <section className="min-h-screen bg-background">
      <div className="relative flex min-h-screen bg-secondary dark:bg-secondary">
...
export function TemplateWorkflow({
  ...
  return (
    <TemplateShell step={step} onBackHome={onBackHome} onTabSelect={onTabSelect} navControls={navControls} ui={ui}>
      <div
        key={step}
        className="relative bg-secondary/95 px-1 pb-1"
      >
        {renderStep()}
      </div>
...
function TemplateDetails({
  ...
  return (
    ...
    >
      ...
      <div className="grid flex-1 items-start gap-5 lg:grid-cols-[minmax(0,1fr)_420px]">
        <section className="rounded-md border border-border/70 bg-card shadow-[0_18px_50px_rgba(12,21,25,0.06)]">
        ...
        <aside className="rounded-md border border-border/70 bg-card shadow-[0_18px_50px_rgba(12,21,25,0.06)]">
    ...
    >
      <div className="flex flex-1 items-center justify-center">
        ...
        >
          ...
          <div className="whitespace-pre-wrap rounded-md border border-border/70 bg-background p-5 text-sm leading-7 text-muted-foreground/80">
            {preview}
          </div>
        </motion.div>
      </div>
...
function TemplateResult({
  ...
  return (
    ...
    >
      <motion.div
        className="relative rounded-[2rem] border border-border/30 bg-secondary p-8 text-foreground shadow-[0_28px_80px_rgba(0,0,0,0.18)]"
      >
