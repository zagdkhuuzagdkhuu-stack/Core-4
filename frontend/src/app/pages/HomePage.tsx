...
export function HomePage({
  ...
  return (
    <>
      ...
      {/* Page 1: Hero */}
      <motion.section
        className="draftly-hero-section relative flex min-h-screen flex-col bg-secondary"
      ...
      >
        {/* Document body */}
        <motion.div
          className="draftly-hero-surface relative flex flex-1 flex-col bg-background"
        >
      ...
      <motion.section
        className="draftly-solar-section relative min-h-screen bg-background py-16 md:py-24"
        ref={featuresRef.ref}
        variants={SECTION_REVEAL}
        initial="hidden"
        whileInView="visible"
      ...
      <motion.section
        className="draftly-template-section relative min-h-screen bg-secondary py-16 md:py-28"
        ref={templateRef.ref}
        variants={SECTION_REVEAL}
        initial="hidden"
        whileInView="visible"
      ...
      <motion.section
        className="draftly-analysis-section relative min-h-screen bg-secondary py-16 md:py-28"
        ref={uploadRef.ref}
        variants={SECTION_REVEAL}
        initial="hidden"
        whileInView="visible"
      ...
      {/* Page 5: Footer */}
      <motion.footer
        className="draftly-footer-section relative z-10 mt-16 border-t border-border bg-secondary"
        ref={footerRef.ref}
        variants={SECTION_REVEAL}
        initial="hidden"
        whileInView="visible"
